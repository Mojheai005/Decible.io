...
import { Play, Download, ChevronRight, Loader2, RotateCcw, Share2, Pause, Globe, Trash2, Volume2, RotateCw, ChevronDown } from 'lucide-react';
    ...
    return (
        <div className="flex h-full bg-white overflow-hidden relative">
            ...
            <div className="flex-1 flex w-full h-full">
                ...
                <div className="flex-1 flex flex-col relative min-w-0 bg-[#F9FAFB]">
                    {/* Scrollable Canvas */}
                    <div className="flex-1 overflow-y-auto relative scroll-smooth p-6 pb-48">
                        <div className="max-w-6xl mx-auto flex flex-col h-full">
                            {/* Paper Editor Card */}
                            <div
                                className="bg-white rounded-3xl shadow-[0_2px_20px_rgba(0,0,0,0.02)] border border-gray-100 p-10 flex-1 min-h-[500px] relative group focus-within:ring-1 focus-within:ring-black/5 focus-within:border-gray-300 transition-all cursor-text flex flex-col"
                                onClick={() => textareaRef.current?.focus()}
                            >
                                <textarea
                                    ref={textareaRef}
                                    className="w-full flex-1 text-2xl leading-relaxed resize-none focus:outline-none font-light placeholder:text-gray-300 bg-transparent text-gray-900 selection:bg-gray-100"
                    ...
                    <div className={`absolute left-1/2 -translate-x-1/2 z-30 pointer-events-auto transition-all duration-500 ${currentTrack ? 'bottom-32' : 'bottom-12'}`}>
                        <div className="bg-white/90 backdrop-blur-xl p-1.5 rounded-full border border-gray-200/60 shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex items-center gap-4 transition-transform hover:scale-[1.01] pl-6 pr-2">
                            ...
                            <button
                                ...
                                className={`flex items-center justify-center px-8 py-2.5 rounded-full font-bold text-sm transition-all duration-300 ${!text.trim()
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar bg-white">
                        ...
                        {activeTab === 'settings' && (
                            <div className="p-8 space-y-8">
                                            ...
                                            >
                                                <div className="relative mt-3">
                                                    ...
                                                    <select
                                                        ...
                                                        className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-xl appearance-none focus:outline-none focus:ring-1 focus:ring-black/20 text-sm font-medium text-gray-700 hover:border-gray-300 transition-colors cursor-pointer"
                                                    >
                                ...
                                <div className="pt-6 border-t border-gray-100 pb-24">
                                    <Toggle
                                        label="Speaker boost"
                                    ...
                                    <div className="flex justify-center mt-8">
                                        <button
                                            onClick={handleReset}
                                            className="flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold text-gray-500 hover:text-black hover:bg-gray-50 transition-all"
                                        >
                                ...
                                <div className="p-4 border-b border-gray-100 sticky top-0 bg-white z-10">
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full pl-3 pr-4 py-2 bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400 transition-colors"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                                    {history.length === 0 ? (
                                        ...
                                        history.map((item) => (
                                            <div
                                                key={item.id}
                                                className={`group flex flex-col gap-2 p-3 rounded-xl cursor-pointer transition-all border ${currentTrack?.id === item.id ? 'bg-gray-50 border-gray-200 shadow-sm' : 'bg-transparent border-transparent hover:bg-gray-50/50'
                                                    }`}
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center justify-between mt-1">
                                                    ...
                                                    <button
                                                        ...
                                                        className="opacity-0 group-hover:opacity-100 p-1.5 hover:bg-white hover:shadow-sm rounded-md text-gray-400 hover:text-red-500 transition-all border border-transparent hover:border-gray-100"
                                                        title="Delete"
                                                    >
            ...
            {/* FULL WIDTH STICKY MEDIA PLAYER */}
            <AnimatePresence>
                {currentTrack && (
                    <motion.div
                        initial={{ y: 100 }}
