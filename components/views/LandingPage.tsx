...
export const LandingPage: React.FC = () => {
  ...
  // Decible Logo SVG component - exact recreation
  const DecibleLogo = ({ size = 32, className = '' }: { size?: number; className?: string }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 100 100"
